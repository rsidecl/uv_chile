...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="h-[100vh] py-40 overflow-hidden  antialiased relative flex flex-col self-auto [perspective:500px] [transform-style:preserve-3d]"
    >
      <Header />
      <motion.div
        style={{
  ...
  return (
    <div className="max-w-7xl relative mx-auto md:py-20 md:py-40 px-4 w-full  left-0 -top-24">
      ...
      <p className="text-center md:text-left text-2xl md:max-w-2xl text-base md:text-xl mt-8 dark:text-neutral-200">
        ...
        líderes de empresas del rubro y por ello, deseamos participar de sus
        necesidades y ganarnos su confianza
      </p>
    </div>
  );
};
